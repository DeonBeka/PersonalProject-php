  ...
  <div class="navbar navbar-dark bg-dark shadow-sm">
    ...
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
        ...
        <p class="lead text-muted">You can book your hotels by clicking the button below</p>
      </div>
    </div>
  </section>
            ...
            <div class="row">
                ...
                <div class="col-lg-7 col-md-7 col-sm-6">
                    ...
                    <div class="form-floating">
                      <input type="number" class="form-control" id="floatingInput" placeholder="Number of nights" name="nr_nights" >
                      <label for="floatingInput">Number of nights</label>
                    </div>
                    <div class="form-floating">
                      <input type="date" class="form-control" id="floatingInput" placeholder="From" name="start_date" >
                      <label for="floatingInput">From Date</label>
                    </div>
                     <div class="form-floating">
                      <input type="date" class="form-control" id="floatingInput" placeholder="To" name="end_date" >
