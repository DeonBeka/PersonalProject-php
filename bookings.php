...
if ($_SESSION['is_admin'] == 'true') {
    $sql = "SELECT hotels.hotel_name, users.email, bookings.id, bookings.nr_nights, bookings.start_date, bookings.end_date
            FROM hotels
            INNER JOIN bookings ON hotels.id = bookings.hotel_id
    ...
    $sql = "SELECT hotels.hotel_name, users.email, bookings.nr_nights, bookings.start_date, bookings.end_date
            FROM hotels 
            INNER JOIN bookings ON hotels.id = bookings.hotel_id 
            INNER JOIN users ON users.id = bookings.user_id 
        ...
        <table class="table table-striped table-sm">
          ...
          <?php if ($_SESSION['is_admin'] == 'true') { ?>
            <?php foreach ($bookings_data as $booking_data) { ?>
               ...
               <tr>
                <td><?php echo $booking_data['hotel_name']; ?></td>
                <td><?php echo $booking_data['email']; ?></td>
                <td><?php echo $booking_data['nr_nights']; ?></td>
